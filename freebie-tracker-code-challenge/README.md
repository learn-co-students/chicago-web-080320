...
## Notes
- aggregate methods - how to find the right enumerable
- understanding the deliverables, figuring out what belongs where
- when to use helper methods/reuse existing code
- syntax for calling and for defining class methods
